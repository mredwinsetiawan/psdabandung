...
echo "
 <tr>
				...
				<?echo"
				<td><a class='btn btn-primary btn-sm' href='edit-aprove.php?kdunix=".$datab[kode]."' onclick='return confirm(&quot;Yakin akan menghapus data?&quot;)'><i class='glyphicon glyphicon-edit'></i> Edit</a></td>
...
$tgl = date("Y-m-d", $tanggal);
            ...
            echo"<script>alert('Pesan Notifikasi Berhasil Dikirim');window.location='rekap_berjalan.php'</script>";
			}
}			
...
echo "
 <tr>
				...
				<?echo"
				<td><a class='btn btn-primary btn-sm' href='edit-aprove.php?kdunix=".$data[kode]."' onclick='return confirm(&quot;Yakin akan mengedit data?&quot;)'><i class='glyphicon glyphicon-edit'></i> Edit</a></td>
