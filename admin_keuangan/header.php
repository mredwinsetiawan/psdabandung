...
<div class="container">
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><span class="glyphicon glyphicon-usd"></span> Admin keuangan</a>
        </div>
...
<?
include"../koneksi.php";
$tampil = "select * from pesan_notifikasi where kepada='admin-keuangan' and status='belum-terbaca'";
