...
$no=0;
$th=date("Y");
$ambildata=mysql_query("SELECT wilayah,YEAR(bulan) AS tahun,month(bulan) AS bulan,sum(jumlah) AS jumlahh FROM rekap_sartek where year(bulan)='$th' GROUP BY wilayah");
$cekdata=mysql_num_rows($ambildata);
if($cekdata=='0'){
echo "<font color='red'><center>Maaf Data tidak ada</center></font>";
}
