...
echo "
 <tr>
				...
				<?echo"
				<td><a class='btn btn-primary btn-sm' href='edit_jumlah_aprove.php?kdunix=".$datab[kode]."' onclick='return confirm(&quot;Yakin akan mengedit data?&quot;)' disabled><i class='glyphicon glyphicon-edit'></i> Edit</a></td>
...
echo "
 <tr>
				...
				<?echo"
				<td><a class='btn btn-primary btn-sm' href='edit_jumlah_aprove.php?kdunix=".$data[kode]."' onclick='return confirm(&quot;Yakin akan mengedit data?&quot;)' disabled><i class='glyphicon glyphicon-edit'></i> Edit</a></td>
