...
<div class="container">
    <div class="row">
        <div class="col-md-12">
    		<center><h3><span class="glyphicon glyphicon-file"></span><br>Rekap Admin Dinas</h3></center>
				...
				<div class="tabbable-line">
					<ul class="nav nav-tabs ">
						<li class="active">
							...
							Rekap Masa Berlaku H-3 Bulan </a>
						</li>
						
						<li>
							<a href="rekap_masa_berlaku_habis.php">
							Rekap Masa Berlaku Habis </a>
						</li>
					</ul>
...
<div class="container">
    <div class="row">
      ...
      <center>
      <h3><span class="glyphicon glyphicon-envelope"></span><br>Kirim Pesan Broadcast<br>User H-3 Bulan / lebih Masa Berlaku</h3>
   ...
   for ($i=0; $i<=$n-1; $i++)
   {
     ...
     if (isset($_POST['pesan'.$i]))
     {
       ...
       mysql_query("INSERT INTO `pesan_notifikasi` (`kode`, `id`, `nama_perusahaan`, `kepada`, `judul`, `pesan`, `foto1`, `tanggal_pengiriman`, `pengirim`, `status`) 
        VALUES (NULL, '$kode', '$nama', '$korwil', 'PEMBERITAHUN', '$_POST[message]', '', NOW(), 'admin-input', 'belum-terbaca');");
...
$hasil  =   mysql_query("SELECT *,DATEDIFF(DATE(NOW()),tanggal_akhir) as jumlah from data_user");
...
<thead>
 <tr class="filters">
              ...
              <th><input type='checkbox' name='pilih2' id='selecctall2' /> PESAN</th>
                        ...
                        <th><input type="text" class="form-control" placeholder="Tanggal Akhir" disabled></th>
