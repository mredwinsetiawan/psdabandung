...
$no=0;
$th=date("Y");
$ambildata=mysql_query("SELECT YEAR(bulan) AS tahun, sum(npa) AS npaw ,sum(volume) as vol FROM rekap_admin_input where korwil='".$promise[wilayah]."'GROUP BY YEAR(bulan)");
