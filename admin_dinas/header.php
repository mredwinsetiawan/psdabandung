...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap-theme.css.map" rel="stylesheet"><style>
/***
...
<?
include"../koneksi.php";
$tampil = "select * from pesan_notifikasi where kepada='admin-dinas' and status='belum-terbaca'";
	...
	<div class="container">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.php">
				...
				<span class="full-nav"> < ADMIN DINAS > </span>
			</a>
		</div>
		<div class="">
			<ul class="nav navbar-nav">
				<li class="active">
					<a href="rekap_masa_berlaku_h-3bulan.php">
				...
				<li>
					<a href="tambah_admin.php">
						<span class="small-nav" data-toggle="tooltip" data-placement="right" title="Tambah Admin"> 
							<span class="fa fa-users"></span> 
						</span>
						<span class="full-nav"><span class="fa fa-users"></span> Tambah Admin </span>
					</a>
				</li>
				<li>
					<a href="daftar_admin_input.php">
						<span class="small-nav" data-toggle="tooltip" data-placement="right" title="Admin Input"> 
							<span class="fa fa-briefcase"></span> 
						</span>
						<span class="full-nav"><span class="fa fa-edit"></span> Admin Input </span>
					</a>
				</li>
				<li>
					<a href="rekap_berjalan_ku.php">
						<span class="small-nav" data-toggle="tooltip" data-placement="right" title="Admin Keuangan"> 
							<span class="fa fa-usd"></span> 
						</span>
						<span class="full-nav"><span class="fa fa-usd"></span> Admin Keuangan </span>
					</a>
				</li>
				<li>
					<a href="rekap_berjalan_sa.php">
						<span class="small-nav" data-toggle="tooltip" data-placement="right" title="Admin Sartek"> 
							<span class="fa fa-calendar"></span> 
						</span>
						<span class="full-nav"><span class="fa fa-calendar"></span> Admin Sartek </span>
					</a>
				</li>
				<li>
