...
include"../koneksi.php";
$no=0; 
$tampil = "select * from rekap_sartek where konfirmasi='terbaru' order by bulan DESC";
...
?>
            <tr>
                ...
                <td><?php echo "<a class='btn btn-warning btn-sm' href='edit_konfirmasi.php?kdunix=".$data[kode]."'><i class='glyphicon glyphicon-edit'></i> Konfirmasi</a> | 
