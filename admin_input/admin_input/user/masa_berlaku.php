...
<div class="container">
      <div class="row">
	  <center><h4><b>Masa Berlaku</b></h4></center>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Masa Berlaku</h3>
            </div>
            <div class="panel-body">
              <div class="row">              
<?
$query3  = mysql_query("SELECT * FROM data_user WHERE kode='$kode'");
$dm   = mysql_fetch_array($query3);
$tgl=substr($dm[tanggal_awal],8,2);
$bulan=substr($dm[tanggal_awal],5,2);
$tahun=substr($dm[tanggal_awal],0,4);

$tgl2=substr($dm[tanggal_akhir],8,2);
$bulan2=substr($dm[tanggal_akhir],5,2);
$tahun2=substr($dm[tanggal_akhir],0,4);
?>
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
					   ...
					   <tr>
					   <hr>
                       <td><b>NO SIPPA:</b><br><?echo"$dm[sippa]";?></td>
                      <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="../images/<?echo"$dm[foto_profil]";?>" width="200" height="200"> </div>
					  <hr>
                      </tr>
					 
					 <tr>
					 <td>Nama Perusahaan:<br> <?echo"$dm[nama_perusahaan]";?></td>
                     </tr>
					 <tr>
					 <td><font color="lightblue">Masa Berlaku Awal:</font><br><?echo"$tgl-$bulan-$tahun";?></td>
                     </tr>
					 
					 <tr>
					 <td><font color="red">Masa Berlaku Akhir :</font><br><?echo"$tgl2-$bulan2-$tahun2";?></td>
                     </tr>
                 ...
                 <div class="panel-footer">
                        <a href="bayar_masa_berlaku.php" data-original-title="Broadcast Message" data-toggle="tooltip" type="button" class="btn btn-sm btn-danger"><h4><i class="glyphicon glyphicon-usd"></i><b> Bayar Perpanjang</b></h4></a>
                    </div>
