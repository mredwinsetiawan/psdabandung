                ...
                <ul class="navigation">
                    ...
                    <li class="active">
                        <a dataprofil-toggle="tab" href="konfirmasi_pembayaran.php">
                            <h4><h4><span class="glyphicon glyphicon-usd"></span></h4></h4>
                        </a>
                    </li>
                    <li>
...
<div class="container">
      <div class="row">
	  <center><h4><b>Konfirmasi<br>Pembayaran Masa Berlaku</b></h4></center>
...
$tgl=substr($tanggalan,8,2);
$bulan=substr($tanggalan,5,2);
$tahun=substr($tanggalan,0,4);

$tgl2=substr($dataprofil[tanggal_akhir],8,2);
$bulan2=substr($dataprofil[tanggal_akhir],5,2);
$tahun2=substr($dataprofil[tanggal_akhir],0,4);
...
if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){ // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
    ...
    if($ukuran_file <= 1000000){ // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
        ...
        if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
            ...
            $query = "insert into rekap_sartek(kode,id,wilayah,nama_perusahaan,bulan,pembayaran,kd_transaksi,atas_nama,foto,jumlah,konfirmasi,tombol) values (null,'".$kode."','".$wilayah."','".$np."','".$tanggalan."','".$pm."','".$kd."','".$an."','".$nama_file_atah."','".$jml."','".$konfirmasi."','".$tb."')";
            $sql = mysql_query($query);
			
            if($sql){ // Cek jika proses simpan ke database sukses atau tidak
                // Jika Sukses, Lakukan :
                echo"<script>alert('Konfirmasi Pembayaran Perpanjangan Sudah Terkirim,Harap Tunggu Notifikasi Dari Admin');window.location='masa_berlaku.php'</script>";
            }else{
                // Jika Gagal, Lakukan :
...
elseif(empty($nama_file1))
{
            ...
            $query = "insert into rekap_sartek(kode,id,wilayah,nama_perusahaan,bulan,pembayaran,kd_transaksi,atas_nama,foto,jumlah,konfirmasi,tombol) values (null,'".$kode."','".$wilayah."','".$np."','".$tanggalan."','".$pm."','".$kd."','".$an."','','".$jml."','".$konfirmasi."','".$tb."')";
            $sql = mysql_query($query);
			 echo"<script>alert('Konfirmasi Pembayaran Perpanjangan Sudah Terkirim,Harap Tunggu Notifikasi Dari Admin');window.location='masa_berlaku.php'</script>";
 }
 }
?>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                     ...
                     <tr>
					 <td><h5><b>Masa Berlaku Habis Pada Bulan: <font color="red"><?echo"$tgl2-$bulan2-$tahun2";?></b></font></h5><br>
                     </tr>
					 <tr>
					 ...
					 <tr>
					 <td><b><h5>Kode Transaksi/Nomor Referensi:</h5></b><br>
                     ...
                     <input type="hidden" name="konfirmasi" value="terbaru">
                     <input type="hidden" name="tbl" value="envelope Kirim Notifikasi?">
                     </tr>
                     <tr>
