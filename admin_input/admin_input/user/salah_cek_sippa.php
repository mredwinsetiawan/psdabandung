                                ...
                                <form accept-charset="UTF-8" role="form" class="form-signin" action="cek_sippa.php" METHOD="POST">
                                    <fieldset>
                                        <label class="panel-login">
                                            <div class="login_result">Sudah Terdaftar Tapi Belum Punya Akun?<br><font color="red">Sippa tidak cocok/sudah teraktivasi</font></div>
                                        </label>
                            ...
                            <div class="panel-body">
                                <form accept-charset="UTF-8" role="form" class="form-signin" action="cek_login.php" METHOD="POST">
                                    <fieldset>
										...
										Login dengan yang lain ? <a href="../index.php">Kembali</a>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
