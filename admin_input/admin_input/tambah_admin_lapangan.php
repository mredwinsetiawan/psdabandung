...
<?
$kode_username =mysql_fetch_array(mysql_query("select * from user_admin_lapangan where wilayah='".$wilayah_admin."' order by kode DESC"));
...
if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){ 
    if($ukuran_file <= 1000000){
        if(move_uploaded_file($tmp_file, $path)){ 
            $query = "INSERT INTO user_admin_lapangan(kode,wilayah,username,foto_profil,password,nama) values (null,'".$wilayah_admin."','PSDA".$tambah."_$_POST[username]','".$nama_file."','$_POST[password]','$_POST[nama]')";
...
{
            $query = "INSERT INTO user_admin_lapangan(kode,wilayah,username,foto_profil,password,nama) values (null,'".$wilayah_admin."','PSDA".$tambah."_$_POST[username]','user_admin.png','$_POST[password]','$_POST[nama]')";
            $sql = mysql_query($query); 
            if($sql){ 
...
echo "<center><h3>Data Admin Lapangan ".$wilayah_admin."<br><span class='glyphicon glyphicon-print'></span></h3>";
