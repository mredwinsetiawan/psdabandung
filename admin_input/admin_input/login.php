                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">                                
                                <div class="row-fluid user-row">
                                    <img src="css/logo.png"  width="100" height="100" class="img-responsive" alt="Conxole Admin"/>
									<br><center><h4>ADMIN INPUT PANEL</h4></center>
                                </div>
                            </div>
                            <div class="panel-body">
                                <form accept-charset="UTF-8" role="form" class="form-signin" action="cek_login.php" METHOD="POST">
                                    <fieldset>
                                        ...
                                        <input class="form-control" placeholder="Email" name="tUser" type="text">
                                        <input class="form-control" placeholder="Password" name="tPwd" type="password">
                                        <br></br>
                                        <input class="btn btn-lg btn-primary btn-block" type="submit" id="login" value="Login ">										Login dengan yang lain ? <a href="../index.php">Kembali</a>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
