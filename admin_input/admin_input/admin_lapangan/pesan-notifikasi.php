...
<?
$kode=$_SESSION['id_lapangan_ciliwung_cisadane'];
$query  = mysql_query("SELECT * FROM pesan_notifikasi WHERE id='$kode' and kepada='admin-lapangan-".$wil."' and  status='belum-terbaca' ");
