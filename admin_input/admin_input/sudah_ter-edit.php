...
$tampil = "select *  from rekap_admin_input where korwil='".$wilayah_admin."' and month(bulan)='$bulan' and year(bulan)='$tahun' order by bulan DESC";
...
include"../../koneksi.php";
$no=0;
$ambildata=mysql_query("SELECT * FROM rekap_admin_input WHERE korwil='".$wilayah_admin."' and bulan >= '$thn1-$bln1-$tgl1' AND bulan <= '$thn2-$bln2-$tgl2' ");
...
echo "
 ...
 <td><img src='admin_lapangan/images/".$datab[gallery1]."' width='100' height='100'></td>
 <td><img src='admin_lapangan/images/".$datab[gallery2]."' width='100' height='100'></td>
 <td><img src='admin_lapangan/images/".$datab[gallery3]."' width='100' height='100'></td>
